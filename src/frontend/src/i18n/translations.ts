const translations = {
  fr: {
    ...
    'status.page1Only': 'seule la page 1 a été traitée',
    ...
    'dl.pdfvec.desc': 'PDF vectoriel anonymisé du tracé ECG.',
  ...
  en: {
    ...
    'status.page1Only': 'only page 1 was processed',
    ...
    'dl.pdfvec.desc': 'Anonymized vectorized PDF of the ECG trace.',
